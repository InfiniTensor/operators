...
def reduce_mean(input, axis, noop_with_empty_axes, keepdims=True):
    if axis == None:
...
def test(
    ...
    if PROFILE:
        ...
        for i in range(NUM_ITERATIONS):
            _ = reduce_mean(x, axes if dynamic_axes == None else dynamic_axes, noop_with_empty_axes, keepdims)
...
if __name__ == "__main__":
    test_cases = [
        ...
        ((30, 5, 20, 100), [0, 1, 2, 3], False, False, None, torch.float16),
